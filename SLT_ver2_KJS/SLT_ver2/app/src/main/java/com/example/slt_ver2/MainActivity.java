...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static TextView Bluetoothtext0; //Bluetooth0
    static TextView Bluetoothtext1; //Bluetooth1
            ...
            if(msg.what == 0){
                switch (msg.arg1){
                    ...
                    case CONNECTED:
                        ...
                        lefthand.setImageResource(R.drawable.left_green);
                ...
                switch (msg.arg1){
                    case DISCONNECT:
                        ...
                        righthand.setImageResource(R.drawable.right_red);
                        break;
                    case CONNECTING:
                        Bluetoothtext1.setTextColor(Color.parseColor("#FF0000"));
                    ...
                    case CONNECTED:
                        ...
                        righthand.setImageResource(R.drawable.right_green);
                        break;
